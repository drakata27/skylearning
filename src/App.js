      ...
      <AuthProvider>
        <div className="App">
          ...
          <Routes>
            ...
            {/* Topics */}
            <Route
              path="/learning/:id/topic/:topicId"
            ...
            <Route
              path="/learning/:id/topic/:topicId/edit"
              element={<EditRoute />}
            >
            ...
            {/* Subtopics */}
            <Route
              path="/learning/:id/topic/:topicId/material/:matId"
              element={<PrivateRoute />}
            >
            ...
            <Route
              path="/learning/:id/topic/:topicId/material/:matId/edit"
              element={<EditRoute />}
            >
            ...
            <Route
              path="/learning/:id/topic/:topicId/add"
              element={<PrivateRoute />}
            >
            ...
            <Route
              path="/material/:matId/flashcard/add"
              element={<PrivateRoute />}
            >
            ...
            <Route
              path="/material/:matId/flashcard/test"
              element={<PrivateRoute />}
            >
            ...
            <Route
              path="/material/:matId/flashcard/:id/edit"
              element={<PrivateRoute />}
            >
