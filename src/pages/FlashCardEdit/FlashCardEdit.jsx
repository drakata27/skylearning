...
const FlashCardEdit = () => {
    ...
    const updateCard = async () => {
        ...
        if (!response.ok) {
            console.error('Error updating card. Server responded with:',
            response.status, response.statusText);
            return;
        }
  ...
  return (
    <div className='flash-card-container'>
      ...
      <input
              ...
              placeholder='Front...'
              value={card.question}
              onChange={(e) => handleInputChange({ target: { value: e.target.value, name: 'question' } })}
          />
          <input
              className='flash-card-input'
              type='text'
              ...
              placeholder='Back...'
              value={card.answer}
              onChange={(e) => handleInputChange({ target: { value: e.target.value, name: 'answer' } })}
            />
