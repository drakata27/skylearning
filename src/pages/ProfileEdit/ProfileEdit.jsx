...
const ProfileEdit = () => {
    ...
    const updateProfile = async () => {
        ...
        if (!response.ok) {
            console.error('Error updating profile. Server responded with:',
            response.status, response.statusText);
            return;
        }
